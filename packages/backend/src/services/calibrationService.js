...
exports.getCalibrationData = exports.pwmToCalibratedRpm = exports.getMsFromCalibration = void 0;
// ===================================================================
//
//                        Kalibrasyon Servisi
//
 ...
 */
const rpmToSpeedIndexMap = new Map([
 ...
 */
const getMsFromCalibration = (targetRpm, targetAngle) => {
...
exports.getMsFromCalibration = getMsFromCalibration;
/**
...
const pwmToCalibratedRpm = (pwm) => {
    ...
    const closestMark = RPM_CALIBRATION_MARKS.reduce((prev, curr) => Math.abs(curr.pwm - pwm) < Math.abs(prev.pwm - pwm) ? curr : prev);
    return closestMark.rpm;
};
exports.pwmToCalibratedRpm = pwmToCalibratedRpm;
/**
 ...
 */
const getCalibrationData = (targetRpm, targetAngle) => {
    ...
    const duration = (0, exports.getMsFromCalibration)(targetRpm, targetAngle);
    if (duration === 0) {
...
exports.getCalibrationData = getCalibrationData;
