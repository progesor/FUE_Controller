...
export interface ServerToClientEvents {
    ...
    'calibration_data_response': (data: {
        pwm: number;
        duration: number;
    }) => void;
...
export interface ClientToServerEvents {
    ...
    'save_device_params': (params: {
        kp: number | string;
        ki: number | string;
    }) => void;
}
export declare const ArduinoCommands: {
    readonly SYS_PING: "SYS.PING";
    readonly SYS_INFO: "SYS.INFO";
    readonly SYS_RESET: "SYS.RESET";
    readonly MOTOR_SET_PWM: "DEV.MOTOR.SET_PWM";
    readonly MOTOR_SET_DIR: "DEV.MOTOR.SET_DIR";
    readonly MOTOR_STOP: "DEV.MOTOR.STOP";
    readonly MOTOR_TIMED_RUN: "DEV.MOTOR.EXEC_TIMED_RUN";
    readonly MOTOR_BRAKE: "DEV.MOTOR.BRAKE";
    readonly BUZZER_BEEP: "DEV.BUZZER.BEEP";
    readonly PIN_SET_MODE: "PIN.SET_MODE";
    readonly PIN_GET_D: "PIN.GET_D";
    readonly PIN_SET_D: "PIN.SET_D";
    readonly PIN_GET_A: "PIN.GET_A";
    readonly PIN_SET_A: "PIN.SET_A";
    readonly ACK: "ACK:";
    readonly ERR: "ERR:";
    readonly EVT: "EVT:";
    readonly DATA: "DATA:";
